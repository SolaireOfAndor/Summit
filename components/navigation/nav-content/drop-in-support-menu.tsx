...
interface DropInSupportMenuProps {
  onNavigate?: () => void
}

/**
 * @component DropInSupportMenu
 * @description SummitSDA menu for Drop-in Support section. Lists all drop-in support services with descriptions and preview.
 * @example
 ...
 * @returns {JSX.Element}
 */
export function DropInSupportMenu({ onNavigate }: DropInSupportMenuProps) {
  const [activeItem, setActiveItem] = useState<NavigationItem>(navigationData.dropInSupport[0])
