...
const LAST_UPDATED = "2026-02-19T00:00:00.000Z"
...
const sitemap = async (): Promise<MetadataRoute.Sitemap> => {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    createEntry("/about/feedback", "monthly", 0.7),
    ...
    createEntry("/learn/about-sda", "monthly", 0.85),
    ...
    createEntry("/learn/about-sil", "weekly", 0.95),
    ...
    createEntry("/learn/funding", "monthly", 0.85),
    ...
    createEntry("/supported-accommodations/sda", "monthly", 0.85),
    ...
    createEntry("/drop-in-support/assistant-with-daily-life", "monthly", 0.75),
    createEntry("/drop-in-support/assistant-with-self-care", "monthly", 0.75),
